...
if (!class_exists('EisTeam')) {
    ...
    class EisTeamController {
         ...
         * Description This function uploads the picture
         * @param type $_files,$fileToUpload,$img_name
